...
def collect(course: Path = COURSE) -> dict:
    ...
    result = {'id':'fundamentos-ciberseguridad', 'version':json.loads((HERE/'package.json').read_text(encoding='utf-8'))['version'],'language':'es', 'repository':REPO, 'modules':modules,
